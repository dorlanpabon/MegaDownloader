    ...
    Private Sub btnAgregar_Click(sender As System.Object, e As System.EventArgs) Handles btnAgregar.Click
        Try
            ...
            Else
                ...
                Dim root As List(Of String) = New List(Of String) From {""}
                Dim URLs2 = URLProcessor.ProcessURLs(URLs, Me.Config, root)
                ...
                With oPaquete
                    ...
                    ElseIf root.Count = 2 Then
                        Dim FolderFather = root.Last
                        .Nombre = FolderFather
                        .PendienteNombrePaquete = False
                        .RutaLocal = System.IO.Path.Combine(.RutaLocal, FolderFather)
                        System.IO.Directory.CreateDirectory(.RutaLocal)
                    End If

Public Class MegaFolderHelper
    ...
    Public Shared Function RetrieveLinksFromFolder(ByVal FolderID As String, ByVal FolderKey As String, ByVal rootFolder As List(Of String)) As Generic.List(Of URLProcessor.FileURL)
        ...
        FileList = CType(Newtonsoft.Json.JsonConvert.DeserializeObject(res.Mensaje.Trim("["c, "]"c),
                                                      GetType(FileListResponse)),
                                                      FileListResponse)
        FileList = FileList
    ...
    Public Shared Function RetrieveLinksFromFolderRoot(ByVal FolderID As String, ByVal FolderKey As String) As Generic.List(Of URLProcessor.FileURL)
        Dim jsonRQ As String
        Dim res As Conexion.Respuesta
